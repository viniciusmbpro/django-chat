...
urlpatterns = [
    ...
    path('chat/<uuid:id>/', ChatDetail.as_view(), name='chat-view'),
    ...
    path('api/chat/update/<uuid:id>/',
         ChatOperationsAPIView.as_view(), name='api-update'),
    path('api/chat/delete/<uuid:id>/',
         ChatDeleteAPIView.as_view(), name='api-delete'),
    path('api/chat/<uuid:id>/', ChatDetailAPIView.as_view(), name='api-detail'),
    path('api/chat/<uuid:id>/add_participant/',
